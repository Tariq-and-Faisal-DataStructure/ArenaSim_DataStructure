...
public class Main_menu {
    ...
    public Scene createMainMenuContent() {
        ...
        Image bgim = new Image(getClass().getResource("WhatsApp Image 2024-04-29 at 10.28.18 PM.jpeg").toExternalForm(), root.getPrefWidth(), root.getPrefHeight(), false, true);
