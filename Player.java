...
public class Player extends Map implements Updatable {
    ...
    public Player(float maxHealth, float BaseAttackSpeed, float damage, int getBaseMovementSpeed, String name,
            Circle Shape) {
        super();
    ...
    /*
     * a refrence to each player to show who he is attaking
     * and who is attaking him
     * 
     * 
     * 
     */
    public Player WhoFollowYou(List<Player> enemies, Player currentPlayer) {
